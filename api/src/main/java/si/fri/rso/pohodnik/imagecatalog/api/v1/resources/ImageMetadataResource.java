...
import si.fri.rso.pohodnik.version.services.beans.ImageMetadataBean;
...
public class ImageMetadataResource {
    ...
    public Response createImageMetadata(@RequestBody(
        ...
        if ((imageMetadata.getfirstName() == null || imageMetadata.getlastName() == null || imageMetadata.getskill() == null)) {
